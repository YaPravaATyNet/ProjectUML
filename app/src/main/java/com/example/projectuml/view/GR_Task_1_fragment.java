...
public class GR_Task_1_fragment extends Fragment implements Checkable {
    ...
    public GR_Task_1_fragment() {
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        final View v = inflater.inflate(R.layout.fragment_gr__task_1_fragment, container, false);
        ...
        rb_1.setText(dbHelper.getTrash(dbHelper.getReadableDatabase(), 21, 30));
        rb_2.setText(dbHelper.getTrash(dbHelper.getReadableDatabase(), 21, 30));
        rb_3.setText(dbHelper.getTrash(dbHelper.getReadableDatabase(), 21, 30));
        rb_4.setText(dbHelper.getTrash(dbHelper.getReadableDatabase(), 21, 30));
